...
/**
 * The shop's open book sketches itself in while a page loads: outlines first,
 * then rule lines, sprigs and flowers, then a soft wash of color. Pure CSS,
 * honors prefers-reduced-motion (everything simply appears drawn).
 */
export default function Loading() {
  return (
    <div className="flex min-h-[60vh] items-center justify-center" role="status" aria-label="Loading The Little Bookshop">
      <div className="text-center">
        <svg viewBox="0 0 220 130" className="mx-auto w-56 sm:w-64" aria-hidden>
